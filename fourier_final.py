...
#Recalling the data
	...
	w = np.linspace(0,1/(1/3),3077) #np.linspace(0.0, 1.0/(2.0*T), N/2) 
...
axs[1].plot(w,2/30.2*np.abs(f[0:int(30.2//2)]))	
axs[1].set_xlim(0.5)
axs[1].set_ylim((0,10000),auto=True)
axs[0].xticks(0, 1/dem_values_whole_period)
plt.xlim(5,75)
plt.ylim(0.4,4000000)
